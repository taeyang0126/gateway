...
import com.lei.gateway.plugin.Plugin;
...
import com.lei.gateway.proxy.NettyServerBootstrap;
import com.lei.gateway.proxy.ProxyContext;
import com.lei.gateway.proxy.RoutingContext;
import com.lei.gateway.proxy.ShutdownCoordinator;
import com.lei.gateway.proxy.UpstreamConnectionPool;
import com.lei.gateway.proxy.WarmupRunner;
...
public class GatewayAutoConfiguration {
    ...
    public MetricsCollector metricsCollector(MeterRegistry meterRegistry,
        ...
        return new MetricsCollector(meterRegistry, observabilityProperties);
    }
